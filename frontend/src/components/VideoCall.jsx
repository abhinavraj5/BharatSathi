    ...
    <div className="fixed inset-0 bg-black text-white flex flex-col">
      ...
      <div className="flex-1 relative">
        ...
        <video
          ...
          playsInline
          muted
          className="absolute bottom-4 right-4 w-40 h-32 border-2 border-white rounded object-cover"
        />
      </div>
      ...
      <div className="p-4 bg-gray-800 flex justify-center gap-4">
        ...
        <button onClick={toggleVideo} className="bg-gray-600 px-4 py-2 rounded">
          {videoOff ? '📷❌' : '📷'}
        </button>

        <button onClick={endCall} className="bg-red-600 px-6 py-2 rounded">
          📞 End Call
        </button>
      </div>
    </div>
